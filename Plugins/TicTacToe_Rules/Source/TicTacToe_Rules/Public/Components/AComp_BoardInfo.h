...
protected:
	// ¬озможность управлени€ переменными из принтов оставлена на случай, если игра будет дорабатыватьс€ дизайнерами
	// ширина игрового пол€
	...
	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = "Field")
	int32 Height;
	// содержимое клеток игропол€
	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = "Field")
	TArray<PlayersSymbol> Field;

	// кол-во символов, которое необходимо выстроить подр€д дл€ того, чтоб победить
